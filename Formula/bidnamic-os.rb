class BidnamicOs < Formula
  ...
  url "https://github.com/bidnamic/homebrew-tap/archive/refs/tags/v2026.06.08-9219995.tar.gz"
  sha256 "ff6f7f1ac4e839503f455197266737de92ff0df17eb49dc59637f0711f4a2573"
  version "2026.06.08-9219995"

  depends_on "python@3.14"
  depends_on "awscli"
  depends_on "aws/aws/amazon-efs-utils"
  # session-manager-plugin is a cask (from aws/tap). Homebrew formulae
  # cannot express cask dependencies, so post_install taps aws/tap and
  # installs the cask automatically.
